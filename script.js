document.getElementById("form").addEventListener("submit", function(event) {
    ...
    if (foodArray.length < 2) {
        document.getElementById("food").innerText = "(Please select atleast 2 food items)";
        return; 
    } else {
        document.getElementById("food").innerText ="Choice of Food (Select atleast 2 of the below)"; 
    }
